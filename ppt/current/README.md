...
2026-09-23 사용자 승인으로 **주요 공개논의 선행 스캔 하드게이트**를 추가했다. 신규 주차·전면 재구성·대규모 보강에서는 목차 전에 국회·정부·법원·경찰·인권위·전문기관 등의 토론회·공청회·숙의/공론화·경청회·공식 의견수렴·기관 권고/회신을 먼저 찾고, 실제 입장·근거·반론·실행조건을 추출한다. 그 맵이 완성되기 전 목차를 최종 승인하지 않는다.
